...
function ExtractTranslations (options, content) {
    ...
    this.regexs = {
        ...
        HtmlFilterSimpleQuoteOneTimeBinding: Helpers.escapeRegExp(this.interpolation.startDelimiter) + '\\s*::\\s*\'((?:\\\\.|[^\'\\\\])*)\'\\s*\\|\\s*translate\\s*(:.*?)?\\s*' + Helpers.escapeRegExp(this.interpolation.endDelimiter),
        HtmlFilterDoubleQuoteOneTimeBinding: Helpers.escapeRegExp(this.interpolation.startDelimiter) + '\\s*::\\s*"((?:\\\\.|[^"\\\\\])*)"\\s*\\|\\s*translate\\s*(:.*?)?\\s*' + Helpers.escapeRegExp(this.interpolation.endDelimiter),
